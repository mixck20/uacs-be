...
exports.register = async (req, res) => {
  try {
    ...
    if (detectedRole === 'student') {
      // STUDENTS: Require course and yearLevel, auto-calculate department
      if (!course || !yearLevel) {
        return res.status(400).json({ 
          message: "Students must provide course and year level" 
        });
      }
      ...
      // Auto-populate department from course code (IGNORE any manually provided department)
